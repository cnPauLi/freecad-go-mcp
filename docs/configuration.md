...
[English](configuration.md) · [中文](configuration.zh.md) · [Back to README](../README.md) · [Installation](installation.md) · [Tools](tools.md)
...
reduce token use. Replace `/path/to/freecad-go-mcp` with the absolute path of the
binary you built (see [installation](installation.md)):
